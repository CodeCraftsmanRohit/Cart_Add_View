...
const connectDB = async () => {
  ...
  await mongoose.connect(`${process.env.MONGODB_URI}`);  //dollar mat bhulna,async	Allows use of await, returns a Promiseawait	Waits for mongoose.connect() to finish
};
